...
modPR = 10; % enter the model number to run PR on - numerical index in models variable **
        ...
        for m = modelsTR % loop over model number(s) specified above
            ...
            elseif tr == 2
                ...
                elseif  mle_em ~= 1
                    ...
                    [s, fits, fitMeasures] = em_MI(s, models(modelsTR), 'xp', kbounds, betabounds);
                    all_s{r,m} = s;
                    all_fits{r,m} = fits;
